...
const Dados = () => {
    ...
    const fetchData = async () => {
        try {
            ...
            const responseToken = await axios.get(`https://api.comunhaorara.com:8081/protected/user/buscar`, {
    ...
    //     try {
    //         const responsePerimetrias = await axios.get(`https://api.comunhaorara.com:8081/perimetria/${userData._id}`);
    //         setPerimetrias(responsePerimetrias.data.reverse());

    //         const responseDobrasCutaneas = await axios.get(`https://api.comunhaorara.com:8081/dobrascutaneas/${userData._id}`);
    ...
    const handleUpdateUserData = async (event) => {
        ...
        try {
            const response = await axios.patch("https://api.comunhaorara.com:8081/protected/userstore/editar", newUserData, {
                headers: { Authorization: `${localStorage.getItem("token")}` }
            });
